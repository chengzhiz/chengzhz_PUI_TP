...
function draw() {
    ...
    push();
    imageMode(CENTER);
    image(deco1, 1280 *  windowWidth/1980, y1, windowWidth/16, windowHeight/6);
    image(deco2, 1380 * windowWidth/1980, y2, windowWidth/16, windowHeight/6);
    image(deco1, 1580 * windowWidth /1980, y3 * 1220/ windowHeight, windowWidth /16, windowHeight/6);
    image(deco2, 1640 * windowWidth /1980, y4 * 1220/ windowHeight, windowWidth /16, windowHeight/6);
    y1 -= speed1; //9
    y2 -= speed2; //8
    y3 -= speed3; //4
    y4 -= speed4; //5
    ...
    // when the mouse is inside the zone, it will move faster
    else {
        speed1 = 9;
        speed2 = 8;
        speed3 = 4;
