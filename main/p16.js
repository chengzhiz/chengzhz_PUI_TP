...
function draw() {
    ...
    if (0 < time < 30){
        ratio = i;
        tint(255, ratio);
        image(deco1, 100* windowWidth/2045, 300* windowHeight/1220); //400 800
    }

    if (30 < time < 60){
        ratio = i - 300;
        tint(255, ratio);
        image(deco2, 740* windowWidth/2045, 780* windowHeight/1220); //400 800
    }

    if (60 < time < 90){
        ratio = i - 600;
        tint(255, ratio);
        image(deco3, 1700* windowWidth/2045, 200* windowHeight/1220); //400 800
    }
